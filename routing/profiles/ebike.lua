...
Elevation.get_inclination_factor = function (inclination)
  ...
  elseif i < -0.06 then return 1.5
  elseif i < -0.05 then return 1.4
  elseif i < -0.04 then return 1.3
  elseif i < -0.03 then return 1.2
  elseif i < -0.02 then return 1.15
  elseif i < -0.01 then return 1.1
  elseif i < 0.00 then return 1.05

  elseif i < 0.02 then return 0.95
  elseif i < 0.04 then return 0.9
  elseif i < 0.05 then return 0.85
  elseif i < 0.06 then return 0.8
  elseif i < 0.07 then return 0.75
  elseif i < 0.08 then return 0.7
  elseif i < 0.09 then return 0.65
  elseif i < 0.12 then return 0.6
  elseif i < 0.14 then return 0.55
  else return 0.5
  end
end
